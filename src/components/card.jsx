        ...
        <article>
          <div className="article-wrapper">
            ...
            <div className="article-body">
              ...
              <a href="#" className="read-more" onClick={goToSingle}>
                <span className="sr-only">More information about the product</span>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </a>
              <h3>Price: {producto.discount_price > 0 ? <i className='discount'>-{producto.discount_price}%-</i> : null}{priceDiscount()}$</h3>
              {producto.discount_price > 0 ? <h3 className='lastPrice'>Last Price:{producto.price}$</h3> : null}
            </div>
          </div>
        </article>
      </section>
